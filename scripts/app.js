...
function deleteTask() {
  ...
  $.ajax({
    type: "DELETE", // HTTP Verb: Remove
    url: API + "/" + id, //  Example: URL ..../api/tasks/1
    success: function () {
      //Seccess: lets remove and add some style to it
